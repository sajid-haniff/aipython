...
# em3=EM_learner(data,3); em3.plot_error(30)    # 3 classes
# em3=EM_learner(data,20); em3.plot_error(30)   # 20 classes
# em3=EM_learner(data,40); em3.plot_error(30)   # 40 classes
# em3=EM_learner(data,1); em3.plot_error(30)   # 1 classes (predict mean)
